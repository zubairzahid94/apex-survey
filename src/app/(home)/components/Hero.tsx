  ...
  return (
    <section className="relative w-full ">
      <div className="relative bg-white">
        ...
        <div className="bg-apex-grey-bluish relative md:absolute md:left-[40%] md:top-20 py-8 px-6 rounded-lg shadow-lg md:w-1/4">
        ...
        <div className="relative z-10 md:absolute md:right-8 md:-bottom-24">
          <Image
            src={"/pngwing 1.png"}
            alt="Hero Image"
            width={100}
      ...
      <div className="flex flex-col md:flex-row w-full h-max gap-12 items-center py-14 px-6 bg-apex-blue text-white">
