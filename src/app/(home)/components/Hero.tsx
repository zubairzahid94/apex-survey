  ...
  return (
    <section className="relative w-full">
      <div className="relative bg-white px-3 lg:px-5">
        ...
        <div className="relative w-full lg:w-3/4 px-6 lg:px-8">
        ...
        <div className="hidden lg:inline-block bg-apex-grey-bluish relative lg:absolute lg:left-[40%] lg:top-20 py-8 px-6 rounded-lg shadow-lg lg:w-1/4">
        ...
        <div className="relative z-10 -bottom-10 lg:absolute lg:right-8 lg:-bottom-24">
          <Image
            src={"/pngwing 1.png"}
            alt="Hero Image"
            width={1000}
      ...
      <div className="flex flex-col xs:flex-row w-full h-max gap-4 lg:gap-12 items-end lg:items-center pt-14 pb-6 px-8 bg-apex-blue text-white">
